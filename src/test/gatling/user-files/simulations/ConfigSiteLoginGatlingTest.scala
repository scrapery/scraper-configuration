...
class ConfigSiteLoginGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the ConfigSiteLogin entity")
        ...
        .repeat(2) {
            ...
            .get("/scrapersetting/api/config-site-logins")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new configSiteLogin")
            .post("/scrapersetting/api/config-site-logins")
            .headers(headers_http_authenticated)
            ...
            .repeat(5) {
                ...
                .get("/scrapersetting${new_configSiteLogin_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created configSiteLogin")
            .delete("/scrapersetting${new_configSiteLogin_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
